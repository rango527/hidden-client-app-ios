//
//  DashboardDateTimeLocationView.swift
//  Hidden Client
//
...
class DashboardDateTimeLocationView: UIView {
    ...
    override func awakeFromNib() {
        ...
        let cellName = "DashboardDateTimeLocationTileCell"
        ...
        tiles.bind(to: collectionView.rx.items(cellIdentifier: cellName)) { (index, item, cell: DashboardDateTimeLocationTileCell) in
...
extension DashboardDateTimeLocationView: DashboardItemViewActions {
