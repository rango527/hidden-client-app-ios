...
class MediaViewerTransition: UIPercentDrivenInteractiveTransition {
    ...
    weak var MediaViewerController: MediaViewerController?

    // MARK: - Transition

    func transition(_ show: Bool) {
        guard let controller = MediaViewerController else { return }
    ...
    @objc func handlePanGesture(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began:
            interactive = true
            MediaViewerController?.presented = false
            MediaViewerController?.dismiss(animated: true, completion: nil)
        ...
        case .ended, .cancelled:
            ...
            interactive = false
            MediaViewerController?.presented = true
    ...
    override func finish() {
        ...
        guard let MediaViewerController = MediaViewerController else { return }
        MediaViewerController.dismissalDelegate?.MediaViewerControllerWillDismiss(MediaViewerController)
    }
}

// MARK: - UIViewControllerAnimatedTransitioning

extension MediaViewerTransition: UIViewControllerAnimatedTransitioning {
...
extension MediaViewerTransition: UIViewControllerTransitioningDelegate {
...
extension MediaViewerTransition: UIGestureRecognizerDelegate {
