...
class PageView: UIScrollView {
    ...
    lazy var playButton: UIButton = {
        ...
        button.setBackgroundImage(#imageLiteral(resourceName: "play"), for: UIControl.State())
    ...
    lazy var loadingIndicator: UIView = MediaViewerConfig.makeLoadingIndicator()

    var image: MediaViewerImage
    ...
    func update(with image: MediaViewerImage) {
        self.image = image
        updatePlayButton()
        fetchImage()
    }
